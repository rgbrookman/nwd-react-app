...
: <><span><strong>Speedily and Safely Turning Your Insights into Greater Joy & Growth</strong></span>  
...
<span>2.    <strong className="boldHeader"><a href={'/insight/quiz/wave'}>Harnessing the Wave:</a></strong></span>
<span className="subtitle" style={{marginBottom: "24px"}}>How to Best Use a Dynamic Hidden Deep in your Data</span>
<span>3.    <strong className="boldHeader"><a href={'/insight/quiz/mindset'}>Making of a Mindset</a></strong></span>
...
<span>4.    <strong className="boldHeader"><a href={'/insight/quiz/representative'}>Making the Data Deeply Representative</a></strong></span>
<span className="subtitle" style={{marginBottom: "24px"}}>Sharing the 3 Keys to Top Quality Data</span>
<span>5.    <strong className="boldHeader"><a href={'/insight/quiz/debrief'}>Getting Value from Any Outcome</a></strong></span>
